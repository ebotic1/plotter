...
NiceButton::NiceButton(const td::String &ButtonText, MenuBar::SubMenuID subMenuID, MenuBar::ActionID actionID, td::ColorID color):
        color(color),
        text(ButtonText),
        action((td::BYTE)subMenuID, (td::BYTE) subMenuID, 0, (td::BYTE)actionID, nullptr)
    {
...
NiceButton::NiceButton(const td::String &ButtonText, std::vector<td::String> pathsToModels, td::ColorID color) : NiceButton(ButtonText, MenuBar::SubMenuID::None, MenuBar::ActionID::None, color)
    {
        openPath = true;
...
//        layoutText(12),
//        buttons{
//            {tr("openFromFile"), MenuBar::SubMenuID::NewModel, MenuBar::ActionID::OpenFromFile},
//            {tr("emptyModel"), MenuBar::SubMenuID::NewGraphical, MenuBar::ActionID::EmptyModel},
//            {tr("emptyModel"), MenuBar::SubMenuID::NewText, MenuBar::ActionID::EmptyModel},
//            {tr("odeModel"), MenuBar::SubMenuID::NewText, MenuBar::ActionID::ODE},
//            {tr("nrModel"), MenuBar::SubMenuID::NewText, MenuBar::ActionID::NR},
//            {tr("wlsModel"), MenuBar::SubMenuID::NewText, MenuBar::ActionID::WLS},
//            {tr("daeModel"), MenuBar::SubMenuID::NewText, MenuBar::ActionID::DAE},
//            //examples
