...
TextEditorView::TextEditorView() : splitter(gui::SplitterLayout::Orientation::Horizontal), vLayout(9), jednacinaLabel("Jednacina:"), dugmadi(1), opcije(5), timeLayout(7),
...
bool TextEditorView::onClick(gui::Button* pBtn) {
...
void TextEditorView::pokreniSolver(){
...
bool TextEditorView::loadFile(const td::String& path) {
	xml::FileParser par;
	StringBuilder s;
	bool x;
...
bool TextEditorView::saveAs(td::String path){
